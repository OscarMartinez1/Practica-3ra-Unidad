...
class JuegoGanadoFragment : Fragment() {
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        binding.siguientePartidaButton.setOnClickListener { view:View->

            view.findNavController().navigate(R.id.action_juegoGanadoFragment_to_juegoFragment)
        }


       /* Toast.makeText(context,"Preguntas Correctas${argumentos.preguntasCorrectamente},Numero de preguntas ${argumentos.numeroPreguntas}",
